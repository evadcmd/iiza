MRKL_INIT_TEMPLATE = """You function as a versatile assistant. Endeavor to answer the subsequent queries to the best of your ability. You passes access to the tools specified below:
